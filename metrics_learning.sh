...
--bs 64 --lr_policy multi-step --lr_steps 50 80 --epoch 100 --embedding_size 256 --use_triplet --lr 0.01 \
--epoch_resume 0 --load_model_dir chkpoints/wide_resnet_SGD_coarse.pth #--use_all_data # --fix_backbone
